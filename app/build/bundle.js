...
function (_Component) {
  ...
  function Login(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleIdChange", function (e) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handlePwChange", function (e) {
      var v = e.target.value;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleLoginOnClick", function (e) {
      alert('클릭22' + _this.state.id + ', ' + _this.state.pw);
    });
...
module.exports = __webpack_require__(/*! E:\DEV\vcode\v2_oneProcess\electron-babel7\app\index.js */"./app/index.js");
